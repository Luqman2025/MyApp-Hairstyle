...
from App1.image_segmentation.model import UNET
from App1.image_segmentation.utils import load_checkpoint, label_to_image
import yaml
...
class face_segment:
    def __init__(self, seg_model_path:str, label_config:str, input_image_size:tuple, device=None):
        ...
        load_checkpoint(torch.load(os.path.join(self.seg_model_path), map_location=torch.device('cpu')), self.model)
